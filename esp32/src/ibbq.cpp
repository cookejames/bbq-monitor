...
static TemperatureResultCallback _temperatureResultCallback = NULL;
...
void iBBQ::connect(TemperatureResultCallback temperatureResultCallback)
{
  _temperatureResultCallback = temperatureResultCallback;
...
void iBBQ::check()
{
  /** ibbq_loop here until we find a device we want to connect to */
  if (!doConnect)
  {
    return;
  }
